...
function isControl(value) {
  return (
    value !== null &&
    typeof value === "object" &&
    (value.metric === "temperature" || value.metric === "humidity") &&
    ["heating", "cooling", "humidifying", "drying"].includes(value.action)
  );
}

function isNullableNumberArray(value, length) {
  return (
    value === null ||
...
function isLightColor(value) {
  return (
    value !== null &&
    typeof value === "object" &&
    (value.color_mode === null || typeof value.color_mode === "string") &&
    isNullableNumberArray(value.rgb, 3) &&
    isNullableNumberArray(value.rgbw, 4) &&
    isNullableNumberArray(value.rgbww, 5) &&
    isNullableNumberArray(value.hs, 2) &&
    isNullableNumberArray(value.xy, 2) &&
    (value.kelvin === null || Number.isFinite(value.kelvin))
  );
}

function isLighting(value) {
  return (
    value !== null &&
    typeof value === "object" &&
    ...
    value.colors.every(isLightColor)
  );
}
...
function isSecurity(value) {
  return (
    ...
    typeof value === "object" &&
    typeof value.available === "boolean" &&
    (value.clear === null || typeof value.clear === "boolean") &&
    (value.available || value.clear === null)
  );
}
...
function isRoom(room) {
  return (
    ...
    Array.isArray(room.controls) &&
    room.controls.every(isControl) &&
    isLighting(room.lighting) &&
    isSecurity(room.security)
  );
}
